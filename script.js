...
var quoteTable = [
    ...
    "The best time to plant a tree was a hundred years ago. The second best time is now.", "Anonymous (Chinese Proverb)",
    ...
    "The talented hawk hides his claws", "Anonymous (Japanese Proverb)",
    "One who chases after two hares won't even catch one", "Anonymous (Japanese Proverb)",
    "Happiness is not something ready-made. It comes from your own actions.", "Tenzin Gyatso (14th Dalai Lama)"
];
...
/* Prevent array from bugging out at boundaries by using *
